...
const translations: Record<string, string> = {
  ...
  'Electricity': 'Umeme',
  'Borehole':'Kisima',
  'Road Frontage':'Mbele ya Barabara',
  'Water Supply': 'Maji',
  'Sewerage': 'Mazao',
  'Ready for Development': 'Kwa Maendeleo',
  'Closer to CBD':'Karibu na Mji',
  'Tiled Floor':'Tailidhi',
  'Agricultural':'Kilimo',
  'Surveyed':'Imepimwa',
  'Fitted Kitchen':'Jiko',
  'Commercial':'Biashara',
  ...
  'Mixed Use':'Mengine',
  'Residential':'Makazi',
  'Tarmac Road Access':'barabara ya Lami',
  'Parking': 'Maegesho',
  'Security': 'Ulinzi',
  'Fence': 'Uzio',
  ...
  'Sitting Room': 'Chumba cha Kukaa',
  'En-suite Bedrooms': 'Vyumba vya kulala na bafu',
  'Balcony': 'Balaza',
  'Store Room': 'Stoo',
  'Servant Quarter': 'Nyumba ya Huduma',
  'Generator': 'Jenereta',
  'Air Conditioning': 'Hali ya Hewa (AC)',
